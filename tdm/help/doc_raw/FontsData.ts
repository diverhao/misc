export class FontsData {
    ...
    static g_fonts: Record<string, Record<string, FontFace>> = {
        ...
        "Inter": {
            ...
            Thin: new FontFace("Inter", `url(resources/fonts/Inter/Inter-VariableFont_opsz.ttf)`, { style: "normal", weight: "300" }),
            Bolder: new FontFace("Inter", `url(resources/fonts/Inter/Inter-VariableFont_opsz.ttf)`, { style: "normal", weight: "500" }),
